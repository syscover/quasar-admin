...
class AdminResourceSeeder extends Seeder
{
    public function run()
    {
        Resource::insert([
            ...
            ['uuid' => 'f2c7c28a-807b-4d35-8967-b66d3b602aed',      'name' => 'admin.customField',                  'has_custom_fields' => false,   'has_attachments' => false,     'package_uuid' => '9e8dbba3-b82b-406f-b71f-060a0494ffba'],
            ['uuid' => 'df939149-bd99-4973-95ea-b3a29b484e56',      'name' => 'admin.customField.fieldGroup',       'has_custom_fields' => false,   'has_attachments' => false,     'package_uuid' => '9e8dbba3-b82b-406f-b71f-060a0494ffba'],
            ['uuid' => 'ddc8ed59-46f8-43cd-8f91-64d300c60d61',      'name' => 'admin.customField.field',            'has_custom_fields' => false,   'has_attachments' => false,     'package_uuid' => '9e8dbba3-b82b-406f-b71f-060a0494ffba'],

...
class AdminResourceSeeder extends Seeder
{
    public function run()
    {
        Resource::insert([
            ...
            ['uuid' => '8afef282-97b7-4802-9238-37c5f511e12b',      'name' => 'admin.user',                         'has_custom_fields' => false,   'has_attachments' => false,     'package_uuid' => '9e8dbba3-b82b-406f-b71f-060a0494ffba'],
